...
export type LessonCreateInput = {
  ...
  title: Scalars['String'];
  typeClass?: InputMaybe<TypeClass>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
  videoId: Scalars['String'];
};
...
export type LessonManyWhereInput = {
  ...
  typeClass?: InputMaybe<TypeClass>;
  /** All values that are contained in given list. */
  typeClass_in?: InputMaybe<Array<TypeClass>>;
  /** All values that are not equal to given value. */
  typeClass_not?: InputMaybe<TypeClass>;
  /** All values that are not contained in given list. */
  typeClass_not_in?: InputMaybe<Array<TypeClass>>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  updatedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export enum LessonOrderByInput {
  ...
  TypeClassAsc = 'typeClass_ASC',
  TypeClassDesc = 'typeClass_DESC',
  UpdatedAtAsc = 'updatedAt_ASC',
  UpdatedAtDesc = 'updatedAt_DESC',
...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null } | null };

export type GetLessonsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, channel?: string | null, description?: string | null, slug: string, tag: string, title: string, typeClass?: TypeClass | null, videoId: string, availableAt?: any | null }> };
